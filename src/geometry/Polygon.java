...
{
    // Note: change this value only if the new version of the class is
    //       incompatible. Try to add new fields that are dynamic and
    //       thus can be safely used with their default value.
    ...
    {
        int new_size = Math.max( pts.length, 1 );
