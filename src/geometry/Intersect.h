...
public:
    ...
    static  bool getIntersection(const QLineF &line1, const QLineF &line2, QPointF & intersect );
    static  bool getIntersection(const QPointF &p1, const QPointF &q1, const QPointF &p2, const QPointF &q2 , QPointF &intersect);
...
protected:
    ...
    static bool getIntersectionParams(const QPointF &p1, const QPointF &q1, const QPointF &p2, const QPointF &q2, QPointF & intersect);
