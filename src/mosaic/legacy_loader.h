...
typedef shared_ptr<class RosetteConnect>ConnectPtr;
...
protected:
    ...
    ConnectPtr  getConnectFigure(xml_node & node);
    ...
    void   setConnectReference(xml_node & node, ConnectPtr ptr);
    ...
    ConnectPtr      getConnectReferencedPtr(xml_node & node);
...
private:
    ...
    QMap<int,ConnectPtr>    connect_ids;
