...
void AQLineEdit::enterEvent(QEnterEvent *event)
{
...
void AQLineEdit::leaveEvent(QEvent *event)
{
    if (isReadOnly()) return;
...
void AQLineEdit::setText(QString txt)
{
    if  (blocked)
    {
        return;
