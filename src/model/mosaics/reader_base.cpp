...
bool ReaderBase::hasReference(xml_node & node)
{
    xml_attribute ref;
...
void ReaderBase::setVertexReference(xml_node & node, VertexPtr ptr)
{
    xml_attribute id;
...
VertexPtr ReaderBase::getVertexReferencedPtr(xml_node & node)
{
    VertexPtr retval;
    xml_attribute ref;
    ref = node.attribute("reference");
