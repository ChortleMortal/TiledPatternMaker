...
public:
    ...
    FigurePtr getMasterFigure() { return masterFigure; }
    FigurePtr getFigureFromEditor();

public slots:
    void slot_figureChoiceSelected(int index);
...
protected:
    ...
    void figureChoiceSelected(int index);
...
private:
    ...
    QComboBox               * choiceCombo2;

    WeakFeatureBtnPtr         currentButton;
    MasterFigureWidget      * mfw;

    QMap<FeatureBtnPtr,FigureEditor*> editorsPerButton;
};
