...
StyleColorFillOriginal::StyleColorFillOriginal(FilledEditor * parent, FilledPtr style, QVBoxLayout * vbox)  : filled(style)
{
    ...
    connect(inside_checkbox,  &QCheckBox::stateChanged, this,   &StyleColorFillOriginal::slot_insideChanged);
    connect(outside_checkbox, &QCheckBox::stateChanged, this,   &StyleColorFillOriginal::slot_outsideChanged);
